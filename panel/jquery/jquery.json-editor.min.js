!(function () {
  var e =
    ...
    o = function (e) {
      ...
      if ((o.appendChild(t), t.styleSheet))
    ...
    function n(e, r) {
      ...
      if ("string" == typeof e)
        (e = e
          ...
          .replace(/>/g, "&gt;")),
          (s += t(e)
            ? '<a href="' + e + '" class="json-string json-url">"' + e + '"</a>'
            : '<span class="json-string">"' + e + '"</span>');
      else if ("number" == typeof e)
        s += '<span class="json-literal json-literal-number">' + e + "</span>";
      else if ("boolean" == typeof e)
        s += '<span class="json-literal json-literal-boolean">' + e + "</span>";
      else if (null === e)
        s += '<span class="json-literal json-literal-null">null</span>';
      else if (e instanceof Array)
        if (e.length > 0) {
          s += '[<ol class="json-array">';
          for (var l = 0; l < e.length; ++l)
            (s += "<li>"),
              o(e[l]) && (s += '<a href class="json-toggle"></a>'),
              (s += n(e[l], r)),
              l < e.length - 1 && (s += ","),
              (s += "</li>");
          s += "</ol>]";
        ...
        if (a > 0) {
          ...
          for (var i in e)
            if (e.hasOwnProperty(i)) {
              s += "<li>";
              var c = r.withQuotes
                ? '<span class="json-string json-property">"' + i + '"</span>'
                : '<span class="json-property">' + i + "</span>";
              (s += o(e[i]) ? '<a href class="json-toggle"></a>' + c : c),
                (s += ": " + n(e[i], r)),
                --a > 0 && (s += ","),
                (s += "</li>");
            }
        ...
        this.each(function () {
          ...
          o(t) && (s = '<a href class="json-toggle"></a>' + s),
            ...
            e(this).on("click", "a.json-toggle", function () {
              ...
              if ((o.toggle(), o.is(":visible")))
                o.siblings(".json-placeholder").remove();
              else {
      ...
      get: function () {
        try {
          return (
            ...
            JSON.parse(this.$container.text())
          );
        } catch (e) {
          throw new Error(e);
        }
